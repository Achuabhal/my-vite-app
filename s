...
// Full array of subjects for 4 semesters
const semestersSubjects = [
  ...
  [
    { name: "Project Lab", teacher: "Teacher12", repeat: 2, isLab: true },
    { name: "Sports", teacher: "Teacher23", repeat: 3 },
    { name: "Mob", teacher: "Teacher34", repeat: 4 },
    { name: "Industrial Specialization", teacher: "Teacher44", repeat: 3 },
    { name: "ST", teacher: "Teacher54", repeat: 4 },
    { name: "ML Lab", teacher: "Teacher64", repeat: 1, isLab: true },
    { name: "EC", teacher: "Teacher47", repeat: 3 },
    { name: "ML", teacher: "Teacher84", repeat: 3 },
    { name: "Library", teacher: "Teacher94", repeat: 2 },
    { name: "Mob Lab", teacher: "Teacher104", repeat: 1, isLab: true },
  ],
  [
    { name: "Project Lab", teacher: "Teacher12", repeat: 2, isLab: true },
    { name: "Sports", teacher: "Teacher23", repeat: 3 },
...
function App() {
  ...
  const semesterSchedules = semestersSubjects.map((semester) =>
    generateSchedule(semester, globalTeacherConflict)
  );
